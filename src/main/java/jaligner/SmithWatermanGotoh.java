...
public final class SmithWatermanGotoh {
     ...
     *
     * @param s1 sequene #1 ({@link jaligner.Sequence})
     * @param s2 sequene #2 ({@link jaligner.Sequence})
     * @param matrix scoring matrix ({@link jaligner.matrix.Matrix})
     ...
     * @see jaligner.Sequence
     * @see jaligner.matrix.Matrix
     */
     ...
     * @return {@link jaligner.Alignment}with the two aligned sequences and alignment
     * score.
     * @see jaligner.Cell
     * @see jaligner.Alignment
     */
